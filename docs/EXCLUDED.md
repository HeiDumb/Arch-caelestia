...
- shell history, generated completion dumps, and browser session restore files
- app login blobs such as Spotify `prefs`
- app runtime databases and per-account state such as Spotify `Users/`
